...
#define VERSION "1.49 December 21 2006"
#include <stdio.h>
#ifdef USE_INDEX
#define strchr index
#endif
...
/* adjust lengths of broken notes */
{
  ...
  switch(cv->brokenmult) {
    default:
      event_error("invalid type of broken rhythm");
    case 1:
      num1 = 3;
      num2 = 1;
      break;
